...
description: Library dependencies are MySQL Connector/C 8, range-v3 >=0.11.0, tabulate and the Qt framework version used during development was 5.15.2 and >=6.2. The code was developed on MSVC 16.9-16.11, MSVC 17.2-17.4, GCC 10.2-12.2, and Clang 11-15.
keywords: [c++ orm, dependencies, tinyorm]
---

# Dependencies

The code was developed on MSVC 16.9-16.11, MSVC 17.2-17.4, GCC 10.2-12.2, and Clang 11-15, so may be assumed it will work on future releases of these compilers. Minimum required ISO C++ standard is c++20.
