...
description: Library dependencies are MySQL Connector/C 8, range-v3 0.11.0, tabulate and the Qt framework version used during development was 5.15.2. The code was developed on MSVC 16.9-16.11.7, GCC 10.2-11.2, and Clang 11-13.
---
