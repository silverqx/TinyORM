...
| --------------------------------- | ----------- |
| `TINYORM_LINKING_SHARED`          | <u>__Must__</u> be defined when you are linking against `TinyORM` shared build (`dll` library). |
...
Now you can try the [`HelloWorld CMake`](hello-world.mdx#) example.
