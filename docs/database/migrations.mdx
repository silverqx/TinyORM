...
:::tip
The `tom integrate zsh` command also accepts the `--path=` option with which you can set the directory location, where the zsh completion file should be created.
:::
