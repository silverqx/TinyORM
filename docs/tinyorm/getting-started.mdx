...
If you need to customize the names of the columns used to store the timestamps, you may define `CREATED_AT` and `UPDATED_AT` private static constants on your model:
    ...
    private:
        ...
        inline static const QString CREATED_AT = QStringLiteral("creation_date");
        /*! The name of the "updated at" column. */
        inline static const QString UPDATED_AT = QStringLiteral("updated_date");
    };

:::tip
You can make these static constants non-inline and initialize them in the cpp file.
:::
