...
namespace Seeders
{
    ...
    using TINYORM_PREPEND_NAMESPACE(Orm::Utils::NullVariant); // NOLINT(misc-unused-using-decls)
    /*! Alias for the Tom Seeder. */
    using TINYORM_PREPEND_NAMESPACE(Tom::Seeder); // NOLINT(misc-unused-using-decls)
