...
namespace Orm::Drivers::MySql
{
    ...
    private:
        ...
        using SetOptionMemFn = std::function<
                                   bool(const MySqlDriverPrivate &, mysql_option,
        ...
        bool setOptionString(mysql_option option, QStringView value,
                             QStringView optionName) const;
        /*! Set the MySQL option to the given unsigned int value. */
        bool setOptionUInt(mysql_option option, QStringView value,
                           QStringView optionName) const;
        /*! Set the MySQL option to the given boolean value. */
        bool setOptionBool(mysql_option option, QStringView value,
                           QStringView optionName) const;
        /*! Set the MySQL protocol type option to the given value. */
        bool setOptionProtocol(mysql_option option, QStringView value,
                               QStringView optionName) const;
        /*! Get the MySQL protocol type option by the given QString value. */
        mysql_protocol_type getOptionProtocol(QStringView value,
                                              QStringView option) const;
// The MYSQL_OPT_SSL_MODE was added in MySQL 5.7.11
        ...
        bool setOptionSslMode(mysql_option option, QStringView value,
                              QStringView optionName) const;
        /*! Get the MySQL SSL-mode option by the given QString value. */
        mysql_ssl_mode getOptionSslMode(QStringView value, QStringView option) const;
#endif

        /*! Log warnings to the console for some boolean connection options. */
        void logBoolOptionWarnings(mysql_option option) const;
        /*! Determine if the given value is the bool true value (true, on, yes, y, 1). */
        bool isTrueBoolOption(QStringView value, QStringView option) const;
        /*! Throw an exception if the given boolean value is wrong. */
        void throwIfWrongBoolOptionValue(QStringView value, QStringView option) const;
