...
namespace Orm
{
    ...
    public:
        ...
        createDatabase(const QString &name, const QString &connection = EMPTY);
        /*! Drop a database from the schema if the database exists. */
        static std::optional<SqlQuery>
        dropDatabaseIfExists(const QString &name, const QString &connection = EMPTY);
        ...
        static void renameColumn(const QString &table, const QString &from,
                                 const QString &to, const QString &connection = EMPTY);

        /*! Drop all tables from the database. */
        static void dropAllTables(const QString &connection = EMPTY);
        /*! Drop all views from the database. */
        static void dropAllViews(const QString &connection = EMPTY);
        /*! Drop all types from the database. */
        static void dropAllTypes(const QString &connection = EMPTY);

        /*! Get all of the table names for the database. */
        static SqlQuery getAllTables(const QString &connection = EMPTY);
        /*! Get all of the view names for the database. */
        static SqlQuery getAllViews(const QString &connection = EMPTY);

        /*! Enable foreign key constraints. */
        static SqlQuery enableForeignKeyConstraints(const QString &connection = EMPTY);
        /*! Disable foreign key constraints. */
        static SqlQuery disableForeignKeyConstraints(const QString &connection = EMPTY);
        ...
        static bool hasTable(const QString &table, const QString &connection = EMPTY);
        ...
        static SchemaBuilder &connection(const QString &name = EMPTY);
    ...
    private:
        ...
        static SchemaBuilder &schemaBuilder(const QString &connection = EMPTY);
