...
namespace Orm::Constants
{
    ...
    SHAREDLIB_EXPORT extern const QChar SQUOTE;
    ...
    SHAREDLIB_EXPORT extern const QString SIZE_; // SIZE collides with a symbol in the Windows header files
    ...
    SHAREDLIB_EXPORT extern const QString HASH_;
    SHAREDLIB_EXPORT extern const QString Progress;
    SHAREDLIB_EXPORT extern const QString ON;
    SHAREDLIB_EXPORT extern const QString OFF;
    SHAREDLIB_EXPORT extern const QString on;
    SHAREDLIB_EXPORT extern const QString off;
    ...
    SHAREDLIB_EXPORT extern const QString NOSPACE3;
    ...
    SHAREDLIB_EXPORT extern const QString SSL_MODE;
    SHAREDLIB_EXPORT extern const QString &ssl_cert;
    SHAREDLIB_EXPORT extern const QString &ssl_key;
    SHAREDLIB_EXPORT extern const QString &ssl_ca;
    SHAREDLIB_EXPORT extern const QString &ssl_mode;
    SHAREDLIB_EXPORT extern const QString Disabled;
    SHAREDLIB_EXPORT extern const QString Preferred;
    SHAREDLIB_EXPORT extern const QString Required;
    SHAREDLIB_EXPORT extern const QString VerifyCA;
