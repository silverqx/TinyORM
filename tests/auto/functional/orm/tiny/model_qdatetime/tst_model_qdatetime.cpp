...
Q_GLOBAL_STATIC_WITH_ARGS(const QString, datetime_, ("datetime")) // NOLINT(misc-use-anonymous-namespace)
...
Q_GLOBAL_STATIC_WITH_ARGS(const QTimeZone, TimeZoneEUBratislava, // NOLINT(misc-use-anonymous-namespace)
