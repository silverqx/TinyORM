...
${TINY_UNPARSED_ARGUMENTS}")
    ...
    # incompatible API, eg. QByteArray::isNull() or QString::toLongLong() is defined inline
    # through this QT_CORE_INLINE_SINCE() deprecated macros and we end up with multiple defined
    # symbols, what means QtCore is compiled with old API without inline because it doesn't define
    # this QT_DISABLE_DEPRECATED_UP_TO and TinyORM has inlined symbols. It of course works with
